...
_G.ApplyTurtleWowScaling = ApplyTurtleWowScaling
_G.IntegrateTurtleWowScaling = IntegrateTurtleWowScaling

-- Debug output
if DEFAULT_CHAT_FRAME then
    DEFAULT_CHAT_FRAME:AddMessage("|cff8ec3e6Pawn: TurtleWowScaling.lua loaded successfully|r")
end
